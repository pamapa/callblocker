...
bool Block::isWhiteListed(const std::string& rNumber) {
  return m_whitelists->isListed(rNumber);
}

bool Block::isBlacklisted(const std::string& rNumber) {
  return m_blacklists->isListed(rNumber);
}
