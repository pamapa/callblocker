...
def application(environ, start_response):
  ...
  if path == "/phones":
    return handle_phones(environ, start_response, params)
  if path == "/online_credentials":
    return handle_online_credentials(environ, start_response, params)
  if path == "/get_list":
    return handle_get_list(environ, start_response, params)
  if path == "/get_lists":
